    ...
    <aside id="sidebar" class="fixed lg:static inset-y-0 left-0 z-40 w-64 bg-dark-800 border-r border-glassBorder transform -translate-x-full lg:translate-x-0 transition-transform duration-300 flex flex-col">
        ...
        <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
            <?php if ($user['role'] === 'admin'): ?>
                ...
                <a href="/ATTENDANCE/admin/coordinators.php" class="nav-link <?= strpos($_SERVER['PHP_SELF'],'admin/coordinators') !== false ? 'active' : '' ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0-.001h6v-1a6 6 0 00-9-5.197M13 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
